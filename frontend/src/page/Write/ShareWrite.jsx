  ...
  return (
    <>
            <div className="write_wrap">
                <h2 className="write_type">교환 일기 작성</h2>
                ...
                <div className='btn_write'>
                    ...
                    <select value={shareCode} onChange={(e) => setShareCode(e.target.value)}>
                        <option value="">교환 일기 선택</option>

                        {rooms?.map((room) => (
                            <option key={room.shareCode.shareCode}
                                    value={room.shareCode.shareCode}>
                                {room.shareCode.roomname}
                            </option>
                        ))}
                    </select>
